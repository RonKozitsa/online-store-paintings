...
export const flowersPaintings: StoreItemInterface[] = [
  ...
  },
  {
    ...
    id: 1,
    price: 100,
    imagesPath: [`${directoryPrefix}/something.jpeg`],
    name: ''
  },
  {
    description: '',
    id: 1,
    price: 100,
    imagesPath: [`${directoryPrefix}/artichok-set/artichok.jpeg`],
    name: ''
  },
  {
    description: '',
    id: 1,
    price: 100,
    imagesPath: [`${directoryPrefix}/pink-flower.jpeg`],
    name: ''
  },
  {
    description: '',
    ...
    price: 100,
    framed: true,
    imagesPath: [`${directoryPrefix}/pink-flowers.jpeg`],
    name: ''
  },
  {
    description: '',
    ...
    price: 100,
    framed: true,
    imagesPath: [`${directoryPrefix}/white-flowers.jpeg`],
    name: ''
  },
  {
    description: '',
    ...
    price: 100,
    imagesPath: [
      `${directoryPrefix}/pink-flowers-bad-quality/left.jpeg`,
      `${directoryPrefix}/pink-flowers-bad-quality/right.jpeg`
    ],
    name: ''
  },
  {
  ...
  },
  {
    ...
    framed: true,
    imagesPath: [
      `${directoryPrefix}/yellow-flowers-set/yellow-flowers.jpeg`,
      `${directoryPrefix}/yellow-flowers-set/preview.jpeg`
    ],
    name: ''
  },
  {
