...
export const naturePaintings: StoreItemInterface[] = [
    {
        description: 'The best vacation locations include exotic palm trees, waves and snorkeling, where my paintings will give a sense of the calm feeling of relaxing on the beach, reading a book while listening to the crashing of the waves in the background.',
        id: 1,
        price: 100,
    ...
    },
    {
        ...
        id: 1,
        price: 100,
        imagesPath: [`${directoryPrefix}/desert-set/left.jpeg`, `${directoryPrefix}/desert-set/middle.jpeg`,
